...
const RESUME_SECTIONS = [
  {
    ...
    icon: "🎓",
    items: [
      { title: "MS Computer Science", sub: "NC State · 2024–2026 · GPA 3.4", tags: ["AI", "Security", "Neural Nets"] },
      { title: "B.Tech Computer Science", sub: "SRM University · 2019–2023 · GPA 4.0", tags: ["Algorithms", "Networks"] },
    ],
  },
  {
    label: "Experience",
    icon: "💼",
    items: [
      { title: "Research Intern", sub: "Secure Computing Institute · 2025–Present", tags: ["RAG", "LLM", "Privacy"] },
      { title: "Software Engineer", sub: "Tata Consultancy Services · 2023–2024", tags: ["Java", "Kafka", "Azure"] },
      { title: "ML Mentee", sub: "Amazon · 2022", tags: ["Python", "ML"] },
    ],
  },
  {
    label: "Skills",
    icon: "⚡",
    items: [
      { title: "AI / ML", sub: "RAG · LangChain · ChromaDB · HuggingFace · Ollama", tags: [] },
      { title: "Backend", sub: "Spring Boot · Kafka · REST · Docker · Kubernetes", tags: [] },
      { title: "Security", sub: "OWASP · SAST/DAST · Snyk · ZAP · GDPR · NIST", tags: [] },
    ],
  },
];
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ color: "#e2e8f0", fontSize: 13, fontWeight: 500, fontFamily: "Syne, sans-serif" }}>
            Yaswanth Mullamuri
          </span>
          <span style={{ color: "#334155", fontSize: 11 }}>/ portfolio</span>
        </div>
        ...
        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
          ...
          <button
            ...
            style={{
              ...
              background: "transparent", color: "#f8c564", fontSize: 11, cursor: "pointer",
      ...
      <div style={{ display: "flex", flex: 1, paddingTop: 52 }}>
        ...
        <aside style={{
          ...
          position: "fixed", top: 52, left: 0, bottom: 0, zIndex: 40,
        }}>
          <div style={{ padding: "20px 18px 0", opacity: panelOpen ? 1 : 0, transition: "opacity 0.2s 0.1s" }}>
            {/* Profile */}
            ...
            {/* Contact links */}
            <div style={{ padding: "14px 0 16px", borderTop: "1px solid rgba(30,41,59,0.6)", marginTop: 8 }}>
        ...
        <main style={{
          ...
          <div style={{ textAlign: "center", marginBottom: 32, animation: "fadeUp 0.5s ease" }}>
            <h1 style={{
              ...
              Ask me about{" "}
              <span style={{
                background: "linear-gradient(90deg,#f8c564,#f97316)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}>Yaswanth</span>
            </h1>
            <p style={{ color: "#334155", fontSize: 13, marginTop: 10, letterSpacing: 0.5 }}>
                ...
                <div key={i} style={{
                  ...
                  <div style={{
                    ...
                    background: msg.role === "user"
                      ? "linear-gradient(135deg,#f8c564,#f97316)"
                      : "rgba(20,28,42,0.9)",
